...
$DIR_LFS/process_guard.py -c "taskset -c 1 $DIR_SWIFT/swift --downrate 307200 -o $LFS_DST_STORE -f aaaaaaaa_128gb_8192 -t 127.0.0.1:1337 -h $HASH -z 8192 --progress" -t $(($TIME-5)) -m $LOGS_DIR/dst -o $LOGS_DIR/dst &
SWIFT_DST_PID=$!
